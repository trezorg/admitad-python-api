...
ADVERTISER_SERVICES_KIND_SINGLE_URL = \
    '%s%s' % (BASE_URL,  'adservices/%(id)s/kind/%(kind)s/')
CAMPAIGN_CATEGORIES_URL = '%s%s' % (BASE_URL,  'categories/')
CAMPAIGN_CATEGORIES_SINGLE_URL = '%s%s' % (BASE_URL,  'categories/%(id)s/')
